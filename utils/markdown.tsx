...
/**
 * Safely parses and renders Markdown using react-markdown.
 * Configured with Tailwind typography styles to override Preflight resets.
 */
  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        // Headings overrides (distinct sizes relative to text-xs body)
