...
export function WeeklyOverview({ daysOfWeek, weeklyHours, maxWeeklyHours }: WeeklyOverviewProps) {
  return (
    <div className="col-span-12 lg:col-span-8 bg-surface-container border border-outline-variant p-unit-4 rounded-lg flex flex-col justify-between">
        ...
        {daysOfWeek.map((day, idx) => {
          ...
          return (
            <div key={day} className="flex-1 flex flex-col items-center gap-2 group/col relative">
              ...
              <div className="w-full bg-surface-container-low/40 rounded-t-sm relative h-28 flex items-end border border-outline-variant/15 overflow-hidden cursor-pointer">
                <div
